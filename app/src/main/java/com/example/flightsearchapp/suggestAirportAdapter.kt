...
class suggestAirportAdapter(
    private val airportChoice: (Airport) -> Unit
) : ListAdapter<Airport, suggestAirportAdapter.AirportViewHolder>(AirportDiffCallback()) {
    ...
    inner class AirportViewHolder(private val binding: ItemAirportSuggestionBinding) :
        ...
        fun bind(airport: Airport) {
            ...
            itemView.setOnClickListener { airportChoice(airport) }
        }
    }
